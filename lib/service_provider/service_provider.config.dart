...
import '../ui/screens/editor_screen/bloc/screenshot_cubit/screenshot_cubit.dart' as _i11;
...
_i1.GetIt $initGetIt(_i1.GetIt get, {String? environment, _i2.EnvironmentFilter? environmentFilter}) {
  ...
  gh.factory<_i10.EditorBloc>(() => _i10.EditorBloc(
      get<_i4.FilePicker>(), get<_i6.Logger>(), get<_i3.ElementIdGenerator>(), get<_i8.Timeline<_i9.Editor>>()));
  gh.factory<_i11.ScreenshotCubit>(() => _i11.ScreenshotCubit(
      get<_i7.ScreenshotService>(), get<_i4.FilePicker>(), get<_i6.Logger>(), get<_i5.ImageEditor>()));
